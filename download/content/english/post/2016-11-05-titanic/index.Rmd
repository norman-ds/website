...
![Bar graph showing that most families had 2 or fewer family members with them](unnamed-chunk-11-1.png){width=100%}
...
![Bar graph showing that most families had 2 or fewer family members with them](unnamed-chunk-17-1.png)
![Bar graph showing that most travel groups had 2 or fewer members with them](unnamed-chunk-17-2.png)
...
![Density plot showing that the highest concentration of fares were around $8](unnamed-chunk-22-1.png)
...
![Bar graph showing that Fare, the title "master", and passenger class 3 had the highest influence on the model](unnamed-chunk-30-1.png)
...
![Histogram of the known age of passengers showing that there were few passengers below age 20, with the most passengers in their late 20s - early 30s](unnamed-chunk-32-1.png)


![Histogram of the predicted age of passengers showing that there were few passengers below age 20, with the most passengers in their early to mid 30s](unnamed-chunk-32-2.png)
...
![Dotplot showing that the glmnet model had a slightly higher accuracy (average around 0.84) compared to the random forest model (average around 0.82)](unnamed-chunk-37-1.png)
