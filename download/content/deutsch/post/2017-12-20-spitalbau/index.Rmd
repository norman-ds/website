...
Somit wird ein Austauschen der Referenzliste erst möglich gemacht. Auch lässt sich eine neue Version erstellen, indem einige Blätter aus anderen Versionen kopiert werden. Reihenfolge, Positionsnummer, Differenzen und Zusammenfassungen rechnet Excel immer wieder neu. Für die nächste Bauetappe werden einfach Blätter ergänzt oder ersetzt und die aktuellste Referenzliste eingefügt. Daraus entstehen einige Excel-Dateien, denen eine sinnvolle Bezeichnung zu geben ist, um später beim Suchen erfolgreich zu bleiben.
